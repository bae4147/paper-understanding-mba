...
| 조건 | 참가자 수 | 완료 | 완료율 |
|------|----------|------|-------|
| Control | 63명 | 52명 | 82.5% |
| EBM-CIMO | 63명 | 56명 | 88.9% |
...
| stoner.192@buckeyemail.osu.edu | 4개 | 1개 | ebm_cimo |
...
| weaver.1081@buckeyemail.osu.edu | 2개 | 1개 | control |
...
| sydney_bell@na.honda.com | 2개 | 1개 | ebm_cimo |
| muenchen.10@buckeyemail.osu.edu | 2개 | 0개 | control |
...
|------|---|----|----|-----|--------|---|
| 총 소요 시간 (분) | 20.44 | 50.09 | 0.03 | 373.61 | 8.05 | 112 |
| 읽기 시간 (분) | 6.2 | 26.67 | 0 | 206.65 | 0.87 | 112 |
| 채팅 시간 (분) | 4.24 | 11.25 | 0 | 98.58 | 1 | 112 |

### 조건별 비교

| 지표 | Control M(SD) | EBM-CIMO M(SD) |
|------|---------------|----------------|
| 총 소요 시간 (분) | 17.5 (44.95) | 23.28 (54.45) |
| 읽기 시간 (분) | 5.65 (27.5) | 6.74 (25.83) |
| 채팅 시간 (분) | 1.82 (2.84) | 6.57 (15.16) |

### 리소스 사용 (focusTime >= 5초)

| 리소스 | Control (n=55) | EBM-CIMO (n=57) |
|--------|----------|----------|
| Infographics | 29명 (52.7%) | 37명 (64.9%) |
| Video | 30명 (54.5%) | 36명 (63.2%) |
| Audio/Podcast | 28명 (50.9%) | 27명 (47.4%) |
| Chat (1회 이상) | 28명 (50.9%) | 34명 (59.6%) |
...
| 지표 | M | SD | Min | Max | Median | n |
|------|---|----|----|-----|--------|---|
| 세션당 메시지 수 (전체) | 1.46 | 2.38 | 0 | 17 | 1 | 112 |
| ㄴ Control | 1.13 | 1.63 | 0 | 8 | 1 | 55 |
| ㄴ EBM-CIMO | 1.79 | 2.89 | 0 | 17 | 1 | 57 |
...
|------|---------------|----------------|----------|--------|------|
| Q1 답변 개수 | 1.09 (0.34) | 1.05 (0.22) | Control | 0.490 | 실천 전략 (Strategies) |
| Q2 답변 개수 | 1.04 (0.27) | 1.02 (0.13) | Control | 0.638 | 맥락 전환 (Context Translation) |
| 새 전략 자신감 | 5.13 (1.19) | 5.21 (1.2) | EBM-CIMO | 0.715 | 1-7점 |
| 실행 가능성 | 4.87 (1.54) | 4.98 (1.49) | EBM-CIMO | 0.705 | 1-7점 |

### NASA-TLX (1-7점)

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value |
|------|---------------|----------------|----------|--------|
| mentalDemand | 3.6 (1.27) | 3.89 (1.18) | EBM-CIMO | 0.210 |
| physicalDemand | 1.58 (0.89) | 1.89 (1.15) | EBM-CIMO | 0.114 |
| temporalDemand | 2.09 (1.34) | 2.58 (1.59) | EBM-CIMO | 0.085 |
| effort | 4.13 (1.64) | 4.26 (1.41) | EBM-CIMO | 0.642 |
| frustration | 2.16 (1.4) | 2.54 (1.53) | EBM-CIMO | 0.177 |
| performance | 5.51 (0.97) | 5.61 (0.91) | EBM-CIMO | 0.560 |
...
|------|---------------|----------------|----------|--------|------|
| researchDesignUnderstanding | 5.51 (1.16) | 4.98 (1.43) | Control | 0.037 ✓ | I understood the research design used in the article (e.g., survey, experiment, interviews). |
| evidenceUnderstanding | 5.31 (1.17) | 5.23 (1.2) | Control | 0.721 | I understood what evidence the authors used to support their claims. |
| overallGoal | 5.78 (0.99) | 5.84 (0.85) | EBM-CIMO | 0.732 | I understood the overall goal and main takeaways of the article. |
| limitationsUnderstanding | 5.09 (1.37) | 4.91 (1.38) | Control | 0.497 | I understood the main limitations the authors described (if any). |
| authorsReasoning | 5.6 (1) | 5.82 (0.82) | EBM-CIMO | 0.200 | I understood the authors' explanations and reasoning presented in the main text. |
| keyResultsUnderstanding | 5.84 (1.14) | 5.82 (0.8) | Control | 0.950 | I understood the key results/findings reported in the article. |
| sampleContextUnderstanding | 5.67 (0.97) | 5.3 (1.3) | Control | 0.090 | I understood who or what was studied (sample/context) and why that matters. |
| connectingIdeas | 5.38 (1.12) | 5.7 (0.92) | EBM-CIMO | 0.103 | I was able to connect different sections or ideas across the article. |
| keyTermsUnderstanding | 5.82 (0.94) | 5.7 (0.9) | Control | 0.507 | I understood the key concepts/terms used in the article. |

#### Critical Engagement

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| verifyCredibility | 4.73 (1.46) | 4.75 (1.64) | EBM-CIMO | 0.927 | I thought about how to verify the credibility of the information sources cited in the article. |
| broaderImplications | 5.65 (1.12) | 5.77 (1.04) | EBM-CIMO | 0.570 | I reflected on the broader implications of the article (e.g., for my team, organization, or decisions). |
| ownIdeas | 5.47 (1.19) | 5.37 (1.22) | Control | 0.651 | I explored my own ideas and interpretations related to the article. |
| questionClaims | 4.93 (1.54) | 4.81 (1.3) | Control | 0.658 | I questioned what I read to judge whether the claims were convincing. |
| alternativePerspectives | 4.45 (1.51) | 4.44 (1.59) | Control | 0.957 | I generated alternative perspectives that challenged some of the article's ideas. |

#### Applicability

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| decision | 5.64 (1.13) | 5.54 (1.03) | Control | 0.654 | I can make an informed decision about whether to apply these findings in my context. |
| outcomes | 5.15 (1.33) | 5 (1.3) | Control | 0.562 | I can assess whether I would achieve similar outcomes if I applied the article's conclusions in my situation. |
| contextDifferences | 5.49 (1.19) | 5.54 (1.14) | EBM-CIMO | 0.812 | I can clearly identify the key differences between the research context and my own situation. |
| confidence | 5.36 (1.33) | 5.42 (1.06) | EBM-CIMO | 0.802 | I feel confident in judging the applicability of this research to my specific situation. |
| differencesImpact | 5.36 (1.27) | 5.42 (1.2) | EBM-CIMO | 0.808 | I can tell which of these differences would matter for applying the findings to my situation. |
| mechanisms | 5.35 (1.24) | 5.23 (1.28) | Control | 0.627 | I can judge whether the underlying mechanisms behind the study's results would also apply in my situation. |
...
|------|----------|------|
| 외부 AI 도구 | 4/112명 | 3.6% |
| 외부 PDF 뷰어 | 18/112명 | 16.1% |

### LLM Trust

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| assumeClearIsAccurate | 4.04 (1.93) | 3.96 (1.64) | Control | 0.835 |  |
| relyForImportance | 3.07 (1.82) | 3.25 (1.55) | EBM-CIMO | 0.592 |  |
| relyWithoutReading | 4.22 (1.8) | 4.28 (1.55) | EBM-CIMO | 0.845 |  |
| competence | 5.24 (1.57) | 5.46 (1.31) | EBM-CIMO | 0.427 | Overall, the GenAI was competent and effective as a tool for assisting with reading. |
| comfortActing | 4.22 (1.7) | 3.93 (1.58) | Control | 0.358 | I have no reservations about acting on the information provided by the GenAI. |
| reliability | 4.22 (1.81) | 4.07 (1.61) | Control | 0.651 | I can always rely on the GenAI when understanding articles. |
| accuracy | 5.45 (1.49) | 5.53 (1.17) | EBM-CIMO | 0.779 | The information provided by the GenAI was accurate. |
| benevolence | 5.16 (1.67) | 4.96 (1.71) | Control | 0.538 | I believe the GenAI is made with my best interests in mind. |
| comfortUsing | 4.15 (1.77) | 4.12 (1.53) | Control | 0.943 | I have no hesitation in using the information provided by the GenAI. |
| confidentWithoutDetails | 3.89 (1.77) | 4.12 (1.77) | EBM-CIMO | 0.493 |  |

### LLM Usefulness

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| conceptHelp | 5.25 (1.65) | 5.6 (1.31) | EBM-CIMO | 0.231 | How helpful was the GenAI for understanding difficult concepts or terminology? |
| findingsHelp | 5.4 (1.68) | 5.74 (1.29) | EBM-CIMO | 0.240 | How helpful was the GenAI for understanding the research findings? |
| overall | 5.51 (1.75) | 5.72 (1.25) | EBM-CIMO | 0.469 | How useful was the GenAI for reading and understanding the article? |
| timeSaving | 5.76 (1.75) | 5.74 (1.67) | Control | 0.935 | How helpful was the GenAI for saving your time? |
| practicalHelp | 5.11 (1.69) | 5.44 (1.28) | EBM-CIMO | 0.251 | How helpful was the GenAI for understanding practical applications? |

### Resource Helpfulness

| 리소스 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value |
|--------|---------------|----------------|----------|--------|
| chatbot | 4.29 (2.42) | 4.23 (2.51) | Control | 0.894 |
| infographic | 4.64 (2.36) | 4.74 (2.26) | EBM-CIMO | 0.820 |
| podcast | 3.89 (2.76) | 3.47 (2.64) | Control | 0.419 |
| video | 4.29 (2.64) | 4.47 (2.35) | EBM-CIMO | 0.702 |
...
|--------|--------|---------|----------|------|------|--------|
| mba6202_tue | 47명 | 22명 | 25명 | 109개 | 47개 | 43.1% |
| mba6202_wed | 51명 | 27명 | 24명 | 80개 | 46개 | 57.5% |
| honda | 28명 | 14명 | 14명 | 34개 | 19개 | 55.9% |
