...
|------|---|----|----|-----|--------|---|
| 총 소요 시간 (분) | 13.26 | 16.41 | 0.1 | 74.66 | 8.08 | 36 |
| 읽기 시간 (분) | 2.36 | 5.04 | 0 | 26.95 | 0.35 | 36 |
| 채팅 시간 (분) | 5.52 | 10.43 | 0.01 | 42.74 | 0.53 | 36 |

### 조건별 비교

| 지표 | Control M(SD) | EBM-CIMO M(SD) |
|------|---------------|----------------|
| 총 소요 시간 (분) | 10.77 (14.34) | 15.75 (17.9) |
| 읽기 시간 (분) | 1.84 (2.94) | 2.88 (6.45) |
| 채팅 시간 (분) | 1.92 (3.6) | 9.11 (13.36) |

### 리소스 사용 (focusTime >= 5초)

| 리소스 | Control (n=18) | EBM-CIMO (n=18) |
|--------|----------|----------|
| Infographics | 11명 (61.1%) | 8명 (44.4%) |
| Video | 11명 (61.1%) | 8명 (44.4%) |
| Audio/Podcast | 10명 (55.6%) | 7명 (38.9%) |
| Chat (1회 이상) | 8명 (44.4%) | 9명 (50%) |
...
| 지표 | M | SD | Min | Max | Median | n |
|------|---|----|----|-----|--------|---|
| 세션당 메시지 수 (전체) | 1.86 | 3.44 | 0 | 17 | 0 | 36 |
| ㄴ Control | 1.17 | 1.71 | 0 | 6 | 0 | 18 |
...
|------|---------------|----------------|----------|--------|
| mentalDemand | 3.56 (1.01) | 4.06 (1.13) | EBM-CIMO | 0.183 |
| physicalDemand | 1.44 (0.68) | 2.22 (1.36) | EBM-CIMO | 0.042 ✓ |
| temporalDemand | 1.67 (0.75) | 2.22 (1.4) | EBM-CIMO | 0.157 |
| effort | 4.39 (1.38) | 4.5 (1.46) | EBM-CIMO | 0.821 |
| frustration | 1.89 (0.94) | 2.83 (1.42) | EBM-CIMO | 0.029 ✓ |
| performance | 5.61 (0.95) | 5.56 (0.83) | Control | 0.857 |
...
|------|---------------|----------------|----------|--------|------|
| researchDesignUnderstanding | 5.44 (1.12) | 5.06 (1.43) | Control | 0.384 | I understood the research design used in the article (e.g., survey, experiment, interviews). |
| evidenceUnderstanding | 5.5 (0.96) | 5.17 (1.26) | Control | 0.391 | I understood what evidence the authors used to support their claims. |
| overallGoal | 5.94 (0.78) | 5.72 (0.73) | Control | 0.397 | I understood the overall goal and main takeaways of the article. |
| limitationsUnderstanding | 5.06 (1.35) | 5 (1.15) | Control | 0.898 | I understood the main limitations the authors described (if any). |
| authorsReasoning | 5.78 (0.85) | 5.56 (0.76) | Control | 0.429 | I understood the authors' explanations and reasoning presented in the main text. |
| keyResultsUnderstanding | 5.94 (1.03) | 5.83 (0.6) | Control | 0.702 | I understood the key results/findings reported in the article. |
| sampleContextUnderstanding | 5.67 (0.94) | 5.17 (1.46) | Control | 0.244 | I understood who or what was studied (sample/context) and why that matters. |
| connectingIdeas | 5.67 (1) | 5.67 (0.67) | 동일 | 1.000 | I was able to connect different sections or ideas across the article. |
| keyTermsUnderstanding | 5.72 (0.8) | 5.56 (0.83) | Control | 0.556 | I understood the key concepts/terms used in the article. |

#### Critical Engagement

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| verifyCredibility | 4.89 (1.37) | 5.06 (1.54) | EBM-CIMO | 0.741 | I thought about how to verify the credibility of the information sources cited in the article. |
| broaderImplications | 5.83 (0.76) | 5.72 (0.99) | Control | 0.716 | I reflected on the broader implications of the article (e.g., for my team, organization, or decisions). |
| ownIdeas | 5.72 (0.8) | 5.33 (1) | Control | 0.220 | I explored my own ideas and interpretations related to the article. |
| questionClaims | 5.33 (1) | 5.22 (1.08) | Control | 0.758 | I questioned what I read to judge whether the claims were convincing. |
| alternativePerspectives | 4.67 (1.37) | 4.72 (1.52) | EBM-CIMO | 0.912 | I generated alternative perspectives that challenged some of the article's ideas. |

#### Applicability

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| decision | 5.5 (1.01) | 5.44 (1.26) | Control | 0.888 | I can make an informed decision about whether to apply these findings in my context. |
| outcomes | 4.89 (1.2) | 5.17 (1.38) | EBM-CIMO | 0.536 | I can assess whether I would achieve similar outcomes if I applied the article's conclusions in my situation. |
| contextDifferences | 5.17 (0.9) | 5.56 (1.07) | EBM-CIMO | 0.258 | I can clearly identify the key differences between the research context and my own situation. |
| confidence | 5.11 (1.05) | 5.44 (1.01) | EBM-CIMO | 0.352 | I feel confident in judging the applicability of this research to my specific situation. |
| differencesImpact | 5.11 (1.05) | 5.56 (1.07) | EBM-CIMO | 0.229 | I can tell which of these differences would matter for applying the findings to my situation. |
| mechanisms | 5.33 (1.11) | 5.56 (1.21) | EBM-CIMO | 0.580 | I can judge whether the underlying mechanisms behind the study's results would also apply in my situation. |
...
|------|----------|------|
| 외부 AI 도구 | 1/36명 | 2.8% |
| 외부 PDF 뷰어 | 6/36명 | 16.7% |

### Post Task

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 설명 |
|------|---------------|----------------|----------|--------|------|
| Q1 답변 개수 | 1.17 (0.5) | 1.06 (0.23) | Control | 0.411 | 실천 전략 (Strategies) |
| Q2 답변 개수 | 1 (0) | 1.06 (0.23) | EBM-CIMO | 0.324 | 맥락 전환 (Context Translation) |
| 새 전략 자신감 | 5.33 (1.15) | 5.06 (1.27) | Control | 0.509 | 1-7점 |
| 실행 가능성 | 5.11 (1.49) | 4.67 (1.56) | Control | 0.402 | 1-7점 |

## 클래스별 통계

| 클래스 | 참가자 | Control | EBM-CIMO | 세션 | 완료 | 완료율 |
|--------|--------|---------|----------|------|------|--------|
| mba6202_tue | 13명 | 7명 | 6명 | 13개 | 13개 | 100% |
| mba6202_wed | 23명 | 11명 | 12명 | 23개 | 23개 | 100% |
