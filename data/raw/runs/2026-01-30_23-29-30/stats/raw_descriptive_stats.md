...
| 조건 | 참가자 수 | 완료 | 완료율 |
|------|----------|------|-------|
| Control | 48명 | 42명 | 87.5% |
| EBM-CIMO | 49명 | 46명 | 93.9% |
...
|------|---|----|----|-----|--------|---|
| 총 소요 시간 (분) | 22.73 | 54.91 | 0.03 | 373.61 | 7.64 | 92 |
| 읽기 시간 (분) | 7.27 | 29.31 | 0 | 206.65 | 0.83 | 92 |
| 채팅 시간 (분) | 4.92 | 12.3 | 0 | 98.58 | 1.07 | 92 |

### 조건별 비교

| 지표 | Control M(SD) | EBM-CIMO M(SD) |
|------|---------------|----------------|
| 총 소요 시간 (분) | 18.98 (49.42) | 26.33 (59.48) |
| 읽기 시간 (분) | 6.6 (30.31) | 7.9 (28.31) |
| 채팅 시간 (분) | 2.02 (3.08) | 7.69 (16.47) |

### 리소스 사용 (focusTime >= 5초)

| 리소스 | Control (n=45) | EBM-CIMO (n=47) |
|--------|----------|----------|
| Infographics | 22명 (48.9%) | 30명 (63.8%) |
| Video | 23명 (51.1%) | 28명 (59.6%) |
| Audio/Podcast | 20명 (44.4%) | 21명 (44.7%) |
| Chat (1회 이상) | 22명 (48.9%) | 28명 (59.6%) |
...
| 지표 | M | SD | Min | Max | Median | n |
|------|---|----|----|-----|--------|---|
| 세션당 메시지 수 (전체) | 1.6 | 2.58 | 0 | 17 | 1 | 92 |
| ㄴ Control | 1.2 | 1.76 | 0 | 8 | 0 | 45 |
| ㄴ EBM-CIMO | 1.98 | 3.12 | 0 | 17 | 1 | 47 |
...
|------|---------------|----------------|----------|--------|------|
| Q1 답변 개수 | 1.09 (0.35) | 1.06 (0.24) | Control | 0.696 | 실천 전략 (Strategies) |
| Q2 답변 개수 | 1.04 (0.29) | 1.02 (0.14) | Control | 0.635 | 맥락 전환 (Context Translation) |
| 새 전략 자신감 | 5.2 (1.07) | 5.15 (1.25) | Control | 0.836 | 1-7점 |
| 실행 가능성 | 5.04 (1.37) | 4.89 (1.48) | Control | 0.617 | 1-7점 |

### NASA-TLX (1-7점)

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value |
|------|---------------|----------------|----------|--------|
| mentalDemand | 3.78 (1.25) | 4.04 (1.05) | EBM-CIMO | 0.278 |
| physicalDemand | 1.62 (0.93) | 1.94 (1.14) | EBM-CIMO | 0.155 |
| temporalDemand | 2.07 (1.22) | 2.43 (1.4) | EBM-CIMO | 0.198 |
| effort | 4.4 (1.6) | 4.38 (1.31) | Control | 0.956 |
| frustration | 2.22 (1.43) | 2.66 (1.56) | EBM-CIMO | 0.170 |
| performance | 5.49 (1) | 5.6 (0.84) | EBM-CIMO | 0.585 |
...
|------|---------------|----------------|----------|--------|------|
| researchDesignUnderstanding | 5.6 (1.08) | 5.15 (1.25) | Control | 0.072 | I understood the research design used in the article (e.g., survey, experiment, interviews). |
| evidenceUnderstanding | 5.42 (1.02) | 5.32 (1.03) | Control | 0.635 | I understood what evidence the authors used to support their claims. |
| overallGoal | 5.69 (0.96) | 5.77 (0.83) | EBM-CIMO | 0.685 | I understood the overall goal and main takeaways of the article. |
| limitationsUnderstanding | 5.16 (1.32) | 5.15 (1.24) | Control | 0.980 | I understood the main limitations the authors described (if any). |
| authorsReasoning | 5.56 (1.02) | 5.77 (0.78) | EBM-CIMO | 0.274 | I understood the authors' explanations and reasoning presented in the main text. |
| keyResultsUnderstanding | 5.87 (1.17) | 5.77 (0.8) | Control | 0.633 | I understood the key results/findings reported in the article. |
| sampleContextUnderstanding | 5.73 (0.93) | 5.43 (1.16) | Control | 0.170 | I understood who or what was studied (sample/context) and why that matters. |
| connectingIdeas | 5.42 (1.14) | 5.74 (0.84) | EBM-CIMO | 0.130 | I was able to connect different sections or ideas across the article. |
| keyTermsUnderstanding | 5.78 (0.92) | 5.57 (0.87) | Control | 0.283 | I understood the key concepts/terms used in the article. |

#### Critical Engagement

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| verifyCredibility | 4.8 (1.39) | 4.87 (1.55) | EBM-CIMO | 0.817 | I thought about how to verify the credibility of the information sources cited in the article. |
| broaderImplications | 5.78 (0.92) | 5.77 (0.97) | Control | 0.953 | I reflected on the broader implications of the article (e.g., for my team, organization, or decisions). |
| ownIdeas | 5.6 (1.02) | 5.45 (1.18) | Control | 0.513 | I explored my own ideas and interpretations related to the article. |
| questionClaims | 5.16 (1.23) | 4.91 (1.2) | Control | 0.350 | I questioned what I read to judge whether the claims were convincing. |
| alternativePerspectives | 4.64 (1.32) | 4.62 (1.61) | Control | 0.930 | I generated alternative perspectives that challenged some of the article's ideas. |

#### Applicability

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| decision | 5.67 (0.94) | 5.62 (1.04) | Control | 0.814 | I can make an informed decision about whether to apply these findings in my context. |
| outcomes | 5.11 (1.2) | 5.09 (1.23) | Control | 0.919 | I can assess whether I would achieve similar outcomes if I applied the article's conclusions in my situation. |
| contextDifferences | 5.56 (0.98) | 5.62 (1.14) | EBM-CIMO | 0.785 | I can clearly identify the key differences between the research context and my own situation. |
| confidence | 5.42 (1.11) | 5.45 (1.07) | EBM-CIMO | 0.915 | I feel confident in judging the applicability of this research to my specific situation. |
| differencesImpact | 5.47 (1.05) | 5.53 (1.22) | EBM-CIMO | 0.786 | I can tell which of these differences would matter for applying the findings to my situation. |
| mechanisms | 5.4 (1.12) | 5.4 (1.1) | EBM-CIMO | 0.986 | I can judge whether the underlying mechanisms behind the study's results would also apply in my situation. |
...
|------|----------|------|
| 외부 AI 도구 | 4/92명 | 4.3% |
| 외부 PDF 뷰어 | 18/92명 | 19.6% |

### LLM Trust

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| assumeClearIsAccurate | 3.64 (1.88) | 3.72 (1.55) | EBM-CIMO | 0.828 |  |
| relyForImportance | 2.82 (1.74) | 3.04 (1.52) | EBM-CIMO | 0.523 |  |
| relyWithoutReading | 3.8 (1.67) | 4.06 (1.6) | EBM-CIMO | 0.446 |  |
| competence | 5.07 (1.61) | 5.34 (1.34) | EBM-CIMO | 0.383 | Overall, the GenAI was competent and effective as a tool for assisting with reading. |
| comfortActing | 3.93 (1.64) | 3.83 (1.64) | Control | 0.765 | I have no reservations about acting on the information provided by the GenAI. |
| reliability | 3.89 (1.7) | 3.96 (1.7) | EBM-CIMO | 0.849 | I can always rely on the GenAI when understanding articles. |
| accuracy | 5.27 (1.54) | 5.45 (1.16) | EBM-CIMO | 0.532 | The information provided by the GenAI was accurate. |
| benevolence | 4.87 (1.67) | 4.85 (1.76) | Control | 0.966 | I believe the GenAI is made with my best interests in mind. |
| comfortUsing | 3.87 (1.73) | 4.04 (1.58) | EBM-CIMO | 0.616 | I have no hesitation in using the information provided by the GenAI. |
| confidentWithoutDetails | 3.56 (1.64) | 3.91 (1.8) | EBM-CIMO | 0.325 |  |

### LLM Usefulness

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value | 질문 |
|------|---------------|----------------|----------|--------|------|
| conceptHelp | 5 (1.67) | 5.49 (1.37) | EBM-CIMO | 0.131 | How helpful was the GenAI for understanding difficult concepts or terminology? |
| findingsHelp | 5.18 (1.73) | 5.64 (1.34) | EBM-CIMO | 0.161 | How helpful was the GenAI for understanding the research findings? |
| overall | 5.27 (1.79) | 5.57 (1.3) | EBM-CIMO | 0.352 | How useful was the GenAI for reading and understanding the article? |
| timeSaving | 5.56 (1.84) | 5.53 (1.75) | Control | 0.950 | How helpful was the GenAI for saving your time? |
| practicalHelp | 4.93 (1.74) | 5.4 (1.36) | EBM-CIMO | 0.156 | How helpful was the GenAI for understanding practical applications? |

### Resource Helpfulness

| 리소스 | Control M(SD) | EBM-CIMO M(SD) | 높은 조건 | p-value |
|--------|---------------|----------------|----------|--------|
| chatbot | 4.09 (2.46) | 3.89 (2.59) | Control | 0.715 |
| infographic | 4.27 (2.43) | 4.55 (2.39) | EBM-CIMO | 0.574 |
| podcast | 3.44 (2.78) | 3.19 (2.67) | Control | 0.661 |
| video | 3.93 (2.74) | 4.34 (2.4) | EBM-CIMO | 0.455 |
...
| mba6202_wed | 49명 | 25명 | 24명 | 78개 | 45개 | 57.7% |
| honda | 1명 | 1명 | 0명 | 1개 | 0개 | 0% |
