...
| 항목 | Control M(SD) | EBM-CIMO M(SD) |
|------|---------------|----------------|
| mentalDemand | 3.47 (1.04) | 4.06 (1.13) |
| physicalDemand | 1.42 (0.67) | 2.22 (1.36) |
| temporalDemand | 1.68 (0.73) | 2.22 (1.4) |
| effort | 4.37 (1.35) | 4.5 (1.46) |
| frustration | 1.84 (0.93) | 2.83 (1.42) |
| performance | 5.63 (0.93) | 5.56 (0.83) |

### Self-Efficacy (1-7점)

#### Reading Comprehension

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 질문 |
|------|---------------|----------------|------|
| researchDesignUnderstanding | 5.42 (1.09) | 5.06 (1.43) | I understood the research design used in the article (e.g., survey, experiment, interviews). |
| evidenceUnderstanding | 5.47 (0.94) | 5.17 (1.26) | I understood what evidence the authors used to support their claims. |
| overallGoal | 5.95 (0.76) | 5.72 (0.73) | I understood the overall goal and main takeaways of the article. |
| limitationsUnderstanding | 5.11 (1.33) | 5 (1.15) | I understood the main limitations the authors described (if any). |
| authorsReasoning | 5.79 (0.83) | 5.56 (0.76) | I understood the authors' explanations and reasoning presented in the main text. |
| keyResultsUnderstanding | 5.95 (1) | 5.83 (0.6) | I understood the key results/findings reported in the article. |
| sampleContextUnderstanding | 5.68 (0.92) | 5.17 (1.46) | I understood who or what was studied (sample/context) and why that matters. |
| connectingIdeas | 5.68 (0.98) | 5.67 (0.67) | I was able to connect different sections or ideas across the article. |
| keyTermsUnderstanding | 5.74 (0.78) | 5.56 (0.83) | I understood the key concepts/terms used in the article. |

#### Critical Engagement

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 질문 |
|------|---------------|----------------|------|
| verifyCredibility | 4.89 (1.33) | 5.06 (1.54) | I thought about how to verify the credibility of the information sources cited in the article. |
| broaderImplications | 5.84 (0.74) | 5.72 (0.99) | I reflected on the broader implications of the article (e.g., for my team, organization, or decisions). |
| ownIdeas | 5.79 (0.83) | 5.33 (1) | I explored my own ideas and interpretations related to the article. |
| questionClaims | 5.37 (0.98) | 5.22 (1.08) | I questioned what I read to judge whether the claims were convincing. |
| alternativePerspectives | 4.68 (1.34) | 4.72 (1.52) | I generated alternative perspectives that challenged some of the article's ideas. |

#### Applicability

| 항목 | Control M(SD) | EBM-CIMO M(SD) | 질문 |
|------|---------------|----------------|------|
| decision | 5.53 (0.99) | 5.44 (1.26) | I can make an informed decision about whether to apply these findings in my context. |
| outcomes | 4.89 (1.17) | 5.17 (1.38) | I can assess whether I would achieve similar outcomes if I applied the article's conclusions in my situation. |
| contextDifferences | 5.16 (0.87) | 5.56 (1.07) | I can clearly identify the key differences between the research context and my own situation. |
| confidence | 5.16 (1.04) | 5.44 (1.01) | I feel confident in judging the applicability of this research to my specific situation. |
| differencesImpact | 5.11 (1.02) | 5.56 (1.07) | I can tell which of these differences would matter for applying the findings to my situation. |
| mechanisms | 5.32 (1.08) | 5.56 (1.21) | I can judge whether the underlying mechanisms behind the study's results would also apply in my situation. |
...
| 항목 | Control M(SD) | EBM-CIMO M(SD) | 설명 |
|------|---------------|----------------|------|
| Q1 답변 개수 | 1.16 (0.49) | 1.06 (0.23) | 실천 전략 (Strategies) |
| Q2 답변 개수 | 1 (0) | 1.06 (0.23) | 맥락 전환 (Context Translation) |
| 새 전략 자신감 | 5.37 (1.13) | 5.06 (1.27) | 1-7점 |
| 실행 가능성 | 5.16 (1.46) | 4.67 (1.56) | 1-7점 |
