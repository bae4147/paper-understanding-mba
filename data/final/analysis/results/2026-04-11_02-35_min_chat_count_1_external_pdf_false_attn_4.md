# Analysis Results — min_chat_count_1_external_pdf_false_attn_4
...
| **──** | **──** | **──** | **──** | **──** | **──** |
| Self-Efficacy: Total Composite (avg of all 20 items) | 5.19 (0.65) | 5.46 (0.83) | 2.12 | 0.150 | 0.032 |
...
| **──** | **──** | **──** | **──** | **──** | **──** |
| LLM Usefulness: Total Composite (avg of 5 items) | 5.63 (1.34) | 5.73 (1.25) | 0.10 | 0.750 | 0.002 |
...
| **──** | **──** | **──** | **──** | **──** | **──** |
| LLM Trust: Total Composite (avg of 10 items) | 4.57 (1.24) | 4.51 (1.41) | 0.03 | 0.868 | 0.000 |
